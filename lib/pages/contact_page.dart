                  ...
                  div(classes: 'social-links', [
                    for (final social in socials)
                      a(
                        ...
                        attributes: const {'target': '_blank', 'rel': 'noopener noreferrer'},
                        [
                          _SocialIcon(label: social.label),
                          .text(social.label),
                        ],
                      ),
                  ]),
...
class _SocialIcon extends StatelessComponent {
  ...
  static const _linkedinPath =
      ...
      ' 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0'
      ' 22.222 0h.003z';

  @override
  Component build(BuildContext context) {
    final pathData = switch (label) {
      'GitHub' => _githubPath,
      'LinkedIn' => _linkedinPath,
      _ => null,
    };

    if (pathData == null) return .fragment([]);
